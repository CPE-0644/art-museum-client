...
<div class="_sign_up_form">
  ...
  <el-form :model="signUp" :rules="rules" label-position="left" status-icon ref="signUp" label-width="120px">
    ...
    <el-form-item label="Interested type" prop="interested">
    ...
    <el-form-item label="Address" prop="address">
      <el-input type="text" v-model="signUp.address"></el-input>
    </el-form-item>
    ...
    <el-form-item>
      <el-button type="primary" @click="submitForm('signUp')">Submit</el-button>
